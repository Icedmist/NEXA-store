      ...
      <div className="self-stretch h-auto flex flex-col md:flex-row justify-between items-stretch pr-0 pb-8 pt-0">
        <div className="h-auto p-4 md:p-8 flex flex-col justify-start items-start gap-8">
          ...
          <div className="self-stretch flex justify-start items-center gap-3">
            <div className="text-center text-[#49423D] text-xl font-semibold leading-4 font-sans">Nexa Retail Hub</div>
          </div>
        ...
        <div className="self-stretch p-4 md:p-8 flex flex-col sm:flex-row flex-wrap justify-start sm:justify-between items-start gap-6 md:gap-8">
          ...
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            <div className="self-stretch text-[rgba(73,66,61,0.50)] text-sm font-medium leading-5 font-sans">Product</div>
            <div className="flex flex-col justify-end items-start gap-2">
              {["Inventory", "POS", "Staff", "Scanner", "Labels"].map((item) => (
                <div key={item} className="text-[#49423D] text-sm font-normal leading-5 font-sans cursor-pointer hover:text-[#37322F] transition-colors">{item}</div>
              ))}
            </div>
          </div>
          ...
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            ...
            <div className="flex flex-col justify-center items-start gap-2">
              {["About us", "Our team", "Careers", "Brand", "Contact"].map((item) => (
                <div key={item} className="text-[#49423D] text-sm font-normal leading-5 font-sans cursor-pointer hover:text-[#37322F] transition-colors">{item}</div>
              ))}
            </div>
          </div>
          ...
          <div className="flex flex-col justify-start items-start gap-3 flex-1 min-w-[120px]">
            ...
            <div className="flex flex-col justify-center items-center gap-2">
              {["Terms of use", "API Reference", "Documentation", "Community", "Support"].map((item) => (
                <div key={item} className="self-stretch text-[#49423D] text-sm font-normal leading-5 font-sans cursor-pointer hover:text-[#37322F] transition-colors">{item}</div>
              ))}
            </div>
          </div>
        </div>
